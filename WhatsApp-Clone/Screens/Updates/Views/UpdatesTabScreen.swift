    ...
    var body: some View {
        HStack(alignment: .top) {
            Image(systemName: "circle.dashed")
                ...
                .imageScale(.large)
            (
                Text("Use Status to dahre photos, text and videos that disappear in 24 hours.")
                +
                Text("")
                +
                Text("Status Privacy")
...
private struct StatusSection: View {
    var body: some View {
        HStack{
            Circle()
                .frame(width: UpdatesTabScreen.Constants.imageDimen,
                       height: UpdatesTabScreen.Constants.imageDimen)
